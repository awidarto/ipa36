<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Foc extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Foc()
		{
            ...
            $this->controller = 'media/admin/foc';
            $this->section = 'ExhibitorEntitlement';
            $this->header = 'Exhibitor & Exhibitor Entitlement';
            $this->where = null;
            $this->bep_site->set_crumb('Exhibitor & Exhibitor Entitlement','media/admin/foc');
        ...
        function index()
        {
            ...
            */
            ...
            $convql = ' (exhibitor = 1 and users.group = 1) '; 
            ...
            if(($type == 'result')){
                $this->bep_site->set_crumb('Search Result','media/admin/foc');
            }
