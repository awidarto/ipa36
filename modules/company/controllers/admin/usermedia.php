<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Usermedia extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Usermedia()
		{
            ...
            $this->controller = 'media/admin/usermedia';
            $this->section = 'DC';
            $this->header = 'Convex Member';
            $this->where = null;
            $this->bep_site->set_crumb('Convex Member','media/admin/usermedia');
        ...
        function index()
        {
            ...
            if($type == 'xml'){
                ...
                $page = $this->config->item('backendpro_template_admin') . "exhibitor_list";
                $this->load->view($page,$data);
            }else{
                $data['page'] = $this->config->item('backendpro_template_admin') . "exhibitor_list";
                $data['module'] = 'media';
