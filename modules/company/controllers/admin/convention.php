<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Convention extends Admin_Controller
	{
		...
		function Convention()
		{
            ...
            $this->controller = 'company/admin/convention';
            $this->section = 'ConventionByCompany';
            $this->header = 'Convention By Company';
            $this->where = null;
            $this->bep_site->set_crumb($this->header,'company/admin/convention');
        ...
        function index()
        {
            ...
            $orderby = ($this->uri->segment(7))?$this->uri->segment(7):"company";
            ...
            */
            ...
            $query = $this->usermodel->getUserByCompany($this->where, null,array('fields'=>$orderby,'order'=>$sort));
            
            unset($query['last_query']);
             
            $total = count($query);
            
            $summary_obj = (object)$query;
            ...
            $query = $this->usermodel->getUserByCompany($this->where, $limit,array('fields'=>$orderby,'order'=>$sort)); 
            
            //$query = $this->usermodel->getUsers($this->where, $limit,array('fields'=>$orderby,'order'=>$sort)); 
            
            
              
            $page_query = $query['last_query'];     
            unset($query['last_query']);
            ...
            if(($type == 'result')){
                $this->bep_site->set_crumb('Search Result','company/admin/convention');
            }
