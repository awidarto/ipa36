<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Conventionpd extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Conventionpd()
		{
            ...
            $this->controller = 'media/admin/conventionpd';
            $this->section = 'ConventionProDomestic';
            $this->header = 'Convention - Professional Domestic';
            $this->where = null;
            $this->bep_site->set_crumb('Convention','media/admin/conventionpd');
        ...
        function index()
        {
            ...
            */
            ...
            $convql = ' ((conv_seq > 0 or (conv_seq = 0 and foc = 1)) and registrationtype = \'Professional Domestic\' and users.group = 1) '; 
            ...
            if(($type == 'result')){
                $this->bep_site->set_crumb('Search Result','media/admin/conventionpd');
            }
            ...
            $summary_list['Total Professional Domestic Attendance'] = $tco;
