<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Boothbuyer extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Boothbuyer()
		{
            ...
            $this->controller = 'media/admin/boothbuyer';
            $this->section = 'BoothBuyer';
            $this->header = 'Booth Buyer';
            $this->where = null;
            $this->bep_site->set_crumb('Booth Buyer','media/admin/boothbuyer');
        ...
        function index()
        {
            ...
            */
            ...
            $query = $this->usermodel->getUserBooths($this->where, null,array('fields'=>$orderby,'order'=>$sort)); 
            ...
            $query = $this->usermodel->getUserBooths($this->where, $limit,array('fields'=>$orderby,'order'=>$sort));   
            ...
            if(($type == 'result')){
                $this->bep_site->set_crumb('Search Result','media/admin/boothbuyer');
            }
            ...
            if($type == 'xml'){
                ...
                $page = $this->config->item('backendpro_template_admin') . "boothbuyer_list";
                $this->load->view($page,$data);
            }else{
                $data['page'] = $this->config->item('backendpro_template_admin') . "boothbuyer_list";
                $data['module'] = 'media';
