 ...
 */
    class Media_model extends Base_model
    {
        ...
        function Media_model()
        {
            ...
            $this->_TABLES = array('Documents' => 'ci_media_library','Routes'=>'ci_doc_routes','Custodian'=>'ci_doc_custodian','LocationMain'=>'ci_loc_main','Companies'=>'ci_companies','CallNumbers'=>'ci_call_main','Users'=>'be_users','Tags'=>'ci_tag','SectionTags'=>'ci_object_tag','Files'=>'ci_files','UserProfiles'=>'be_user_profiles');
