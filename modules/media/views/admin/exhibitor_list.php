...
<table class="data_grid" cellspacing="0"  valign="middle" >
    <thead>
        <tr>
            <th width="10%" class="middle top" >ID</th>
            <th class="sidepad">Username</th>
            <th class="sidepad">Contacts</th>
            <th class="sidepad top center" colspan="4">Convention</th>
            <th class="sidepad top center" colspan="5">Short Courses</th>
            <th class="sidepad">Exhibitor</th>
            <th class="sidepad">Media</th>
        </tr>
        <tr>
            <th width=5%>&nbsp;</th>
            <th class="sidepad">&nbsp;</th>
            <th class="sidepad">&nbsp;</th>
            <th class="sidepad">Convention</th>
            <th class="sidepad">Golf</th>
            <th class="sidepad">Wait List</th>
            <th class="sidepad">Gala Dinner</th>
    ...
    <tfoot>
        <tr>
            <td colspan=14>* Click on <span style="color:red">red</span> colored property to edit</td>
            <!--
    ...
    <tbody>
        ...
        <tr class="left_align">
            ...
            <td class="top" style="padding:5px;">
                ...
                <?php print $row->username.'<br />'.$row->conv_id;?>
            </td>
