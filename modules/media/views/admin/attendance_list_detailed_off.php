...
<?php if(isset($documents)): ?>
    <tbody>
        <?php foreach($documents as $row):
            ...
            $delete = '';
            $picture = get_avatar($row->user_id,$this->config->item('public_folder').'avatar/','.jpg','','_off_sm');
        ...
        <tr class="left_align" id="<?=$row->id;?>">
            ...
            <td class="middle" style="padding:5px;width:200px;">
                <a class="preview" href="<?=site_url('/media/admin/media/contactlogoff/'.$row->user_id.'/'.time());?>">
