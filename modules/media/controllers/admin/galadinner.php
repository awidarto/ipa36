<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Galadinner extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Galadinner()
		{
            ...
            $this->controller = 'media/admin/galadinner';
            $this->section = 'Galadinner';
            $this->header = 'Gala Dinner';
            $this->where = null;
            $this->bep_site->set_crumb('Gala Dinner','media/admin/galadinner');
        ...
        function index()
        {
            ...
            */
            ...
            $convql = ' (galadinner > 0 and users.group = 1) '; 
            ...
            if(($type == 'result')){
                $this->bep_site->set_crumb('Search Result','media/admin/galadinner');
            }
