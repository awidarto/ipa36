<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Mp extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Mp()
		{
            ...
            $this->controller = 'media/admin/mp';
            $this->section = 'MediaPerson';
            $this->header = 'Media Person';
            $this->where = null;
            $this->bep_site->set_crumb('Media Person','media/admin/mp');
        ...
        function index()
        {
            ...
            */
            ...
            $convql = ' (media = 1 and users.group = 1) '; 
            ...
            if(($type == 'result')){
                $this->bep_site->set_crumb('Search Result','media/admin/mp');
            }
            ...
            $summary_list['Exhibitor'] = $ex;
            $summary_list['Entitled Exhibitor'] = $foc;
            $summary_list['Media'] = $media;
