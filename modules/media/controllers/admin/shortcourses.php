<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Shortcourses extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Shortcourses()
		{
            ...
            $this->controller = 'media/admin/shortcourses';
            $this->section = 'Shortcourses';
            $this->header = 'Short Courses';
            $this->where = null;
            $this->bep_site->set_crumb('Short Courses','media/admin/shortcourses');
        ...
        function index()
        {
            ...
            */
            ...
            $convql = ' ((course_1 + course_2 + course_3 + course_4 + course_5 > 0) and users.group = 1) '; 
            ...
            if(($type == 'result')){
                $this->bep_site->set_crumb('Search Result','media/admin/shortcourses');
            }
