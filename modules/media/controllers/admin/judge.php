<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Judge extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Judge()
		{
            ...
            $this->controller = 'media/admin/judge';
            $this->section = 'Judge';
            $this->header = 'Judge';
            $this->where = null;
            $this->bep_site->set_crumb('Judge','media/admin/judge');
        ...
        function index()
        {
            ...
            */
            ...
            $convql = ' (judge = \'yes\' and (profiles.registrationtype =\'Professional Domestic\' or profiles.registrationtype =\'Professional Overseas\') and users.group = 1) '; 
            ...
            if(($type == 'result')){
                $this->bep_site->set_crumb('Search Result','media/admin/judge');
            }
            ...
            $summary_list['Judge Participants'] = $judge;
