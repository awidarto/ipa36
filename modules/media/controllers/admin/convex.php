<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Convex extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Convex()
		{
            ...
            $this->controller = 'media/admin/convex';
            $this->section = 'Convex';
            $this->header = 'Master Data';
            $this->where = null;
            $this->bep_site->set_crumb('Master Data','media/admin/convex');
        ...
        function index()
        {
            ...
            */
            ...
            if(($type == 'result')){
                $this->bep_site->set_crumb('Search Result','media/admin/convex');
            }
            ...
            $summary_list['Total Short Course Attendance'] = $tsc;
            $summary_list['Convention Only Attendance'] = $co;
            $summary_list['Short Course Only Attendance'] = $sco;
            $summary_list['Convention and Short Course Attendance'] = $co_sc;
            $summary_list['Golf Attendance'] = $golf;
            $summary_list['Gala Dinner Attendance'] = $gala;
            $summary_list['Gala Dinner Additional Attendance'] = $galaaux;
            ...
            if($type == 'xml'){
                ...
                $data['page'] = $this->config->item('backendpro_template_admin') . "convention_list_detailed";
                $data['module'] = 'media';
