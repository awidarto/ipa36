<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Conventionso extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Conventionso()
		{
            ...
            $this->controller = 'media/admin/conventionso';
            $this->section = 'ConventionStudentOverseas';
            $this->header = 'Convention - Student Overseas';
            $this->where = null;
            $this->bep_site->set_crumb('Convention','media/admin/conventionso');
        ...
        function index()
        {
            ...
            */
            ...
            $convql = ' ((conv_seq > 0) and foc = 0 and registrationtype = \'Student Overseas\' and users.group = 1) '; 
            ...
            if(($type == 'result')){
                $this->bep_site->set_crumb('Search Result','media/admin/conventionso');
            }
            ...
            $summary_list['Total Student Overseas Attendance'] = $tco;
