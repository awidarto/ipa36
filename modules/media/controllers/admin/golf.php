<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Golf extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Golf()
		{
            ...
            $this->controller = 'media/admin/golf';
            $this->section = 'Golf';
            $this->header = 'Golf';
            $this->where = null;
            $this->bep_site->set_crumb('Golf','media/admin/golf');
        ...
        function index()
        {
            ...
            */
            ...
            $convql = ' (profiles.golf > 0 and users.group = 1) '; 
            ...
            $summary_list['Golf Non Waiting List'] = $golfnowait;
            $summary_list['Golf Waiting List'] = $golfwait;
