<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
	class Convention extends Admin_Controller
	{
		/**
		 * Constructor
		 */
		function Convention()
		{
            ...
            $this->controller = 'media/admin/convention';
            $this->section = 'Convention';
            $this->header = 'Convention';
            $this->where = null;
            $this->bep_site->set_crumb('Convention','media/admin/convention');
        ...
        function index()
        {
            ...
            $orderby = ($this->uri->segment(7))?$this->uri->segment(7):"profiles.company";
            ...
            */
            ...
            //$convql = ' (conv_seq > 0 or (conv_seq = 0 and foc = 1)) and users.group = 1 '; 
            $convql = ' (foc = 0 and (registrationtype = \'Professional Domestic\' or registrationtype = \'Professional Overseas\' or registrationtype = \'Student Domestic\' or registrationtype = \'Student Overseas\')) and users.group = 1 '; 
            ...
            if(($type == 'result')){
                $this->bep_site->set_crumb('Search Result','media/admin/convention');
            }
            ...
            $summary_list['Total Convention Attendance'] = $tco;
            ...
            if($type == 'xml'){
                ...
                $selview = (check('Access Control',NULL,FALSE))?"convention_list_detailed":"convention_list";
                $data['page'] = $this->config->item('backendpro_template_admin') . $selview;
                $data['module'] = 'media';
