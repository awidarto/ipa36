...
$config['asset'][] = array('file'=>'admin_style.css');
...
$config['asset'][] = array('file'=>'ui-lightness/jquery-ui-1.8.9.custom.css','name'=>'ui_lightness');
$config['asset'][] = array('file'=>'jquery.lightbox-0.5.css','name'=>'lightbox_css');
$config['asset'][] = array('file'=>'fancybox/jquery.fancybox-1.3.4.css','name'=>'fancybox_css');


// BackendPro JS
//$config['asset'][] = array('file'=>'http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js', 'name'=>'jquery', 'position'=>'header');
//$config['asset'][] = array('file'=>'http://ajax.googleapis.com/ajax/libs/jqueryui/1.5.3/jquery-ui.min.js', 'name' => 'jquery_ui', 'needs'=>'jquery', 'position'=>'header');
$config['asset'][] = array('file'=>'jquery-1.4.4.min.js', 'name'=>'jquery', 'position'=>'header');
$config['asset'][] = array('file'=>'jquery-ui-1.8.9.custom.min.js', 'name' => 'jquery_ui', 'needs'=>'jquery', 'position'=>'header');
$config['asset'][] = array('file'=>'jquery.lightbox-0.5.min.js', 'name'=>'jquery_lightbox','needs'=>'jquery', 'position'=>'header');
$config['asset'][] = array('file'=>'fancybox/jquery.fancybox-1.3.4.js', 'name'=>'jquery_fancybox','needs'=>'jquery', 'position'=>'header');
$config['asset'][] = array('file'=>'fancybox/jquery.easing-1.3.pack.js', 'name'=>'jquery_easing','needs'=>'jquery', 'position'=>'header');
...
$config['asset'][] = array('file'=>'jeip.js', 'name'=>'jquery_eips','needs'=>'jquery', 'position'=>'header');
$config['asset'][] = array('file'=>'jquery.editinplace.js', 'name'=>'jquery_editinplace','needs'=>'jquery', 'position'=>'header');
 ...
 */
$config['asset_group']['SITE'] = 'reset|typography|jquery';
$config['asset_group']['PUBLIC'] = 'bep_front_layout|FlashStatus|forms|buttons|ui_lightness|fancybox_css|jquery_ui|jquery_fancybox|jquery_eips|jquery_editinplace';
$config['asset_group']['ADMIN'] = 'bep_admin_layout|bep_admin_style|admin_style|FlashStatus|forms|buttons|bep_navigation|treeview|bep_icons|bep_select_all|fancybox_css|jquery_fancybox|ui_lightness|jquery_ui|jquery_eips|jquery_editinplace';
