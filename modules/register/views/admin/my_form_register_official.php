...
<?php print form_open('register/admin/register/official/'.$this->validation->id,array('class'=>'horizontal'))?>
    <fieldset>
        <ol>
            <li>
            ...
            <li>
                <?php print form_label('Role :','registrationtype')?>
                <?php print form_dropdown('registrationtype', $this->config->item('off_roles'),$this->validation->registrationtype,'id="registrationtype"');?>
            ...
            <li class="submit" style="float:right;">
            	<div class="buttons">
            		<a href="<?php print base_url() ?>media/admin/officials" class="negative" >
...
<?php
//print_r($this->config->item('off_roles'));
?>