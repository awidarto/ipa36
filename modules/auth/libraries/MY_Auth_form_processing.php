...
class MY_Auth_form_processing
{
	...
	function _register()
	{
		...
		$data['user_profiles']['fullname'] = $this->CI->input->post('fullname');
		$data['user_profiles']['gender'] = $this->CI->input->post('gender'); 
		$data['user_profiles']['company'] = $this->CI->input->post('company');
		
		$dob = $this->CI->input->post('dob_y').'-'.$this->CI->input->post('dob_m').'-'.$this->CI->input->post('dob_d');
		$data['user_profiles']['dob'] = $dob;
		$data['user_profiles']['street'] = $this->CI->input->post('street');
		$data['user_profiles']['city'] = $this->CI->input->post('city');
		$data['user_profiles']['zip'] = $this->CI->input->post('zip');
		$data['user_profiles']['country'] = $this->CI->input->post('country');
		$data['user_profiles']['domain'] = $this->CI->input->post('domain');
	...
	function register_form($container)
	{
		...
		if($this->CI->preference->item('allow_user_profiles')){
		...
		if ( $this->CI->validation->run() === FALSE )
		{
			...
			$data['page'] = $this->CI->config->item('backendpro_template_public') . 'my_form_register';
			$data['module'] = 'auth';
			$this->CI->load->view($container,$data);
		}
		else
