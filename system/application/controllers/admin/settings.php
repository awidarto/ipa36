...
class Settings extends Admin_Controller
{
	...
	function index()
	{
		...
		$config['group'] = array(
                ...
                'convex'     => array('name'=> 'Conference & Exhibition', 'fields'=>'convention_registration_date,exhibition_registration_date,sponsorship_registration_date,booth_booking_limit'),
		...
		$config['field']['convention_registration_date'] = array('type'=>'text','rules'=>'trim|required');
		$config['field']['exhibition_registration_date'] = array('type'=>'text','rules'=>'trim|required');
		$config['field']['sponsorship_registration_date'] = array('type'=>'text','rules'=>'trim|required');
		$config['field']['booth_booking_limit'] = array('type'=>'text','rules'=>'trim|required');
