...
function index()
{
	...
	$this->load->module_library('dashboard','Ipa_stat_widget');
	...
	$this->dashboard->assign_widget(new widget($this->lang->line('ipa_statistics'),$this->ipa_stat_widget->create()),'right');
